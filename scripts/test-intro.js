...
const tests = [
  ...
  ['coarse API time updates can settle', () => { const h=harness({coarse:true});h.play();h.advance(6900);assert.equal(h.intro.removed,true); }],
