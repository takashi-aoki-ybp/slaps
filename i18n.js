...
const I18N = {
  en: {
    ...
    aboutHow: [
      ...
      '<svg class="about-icon" viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><text x="12" y="16.5" font-family="\'Inter\', -apple-system, sans-serif" font-weight="bold" font-size="12" text-anchor="middle" fill="currentColor" stroke="none">UI</text></svg> to keep the UI visible (turn OFF to focus on the MV)',
  ...
  ja: {
    ...
    aboutHow: [
      ...
      '<svg class="about-icon" viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><text x="12" y="16.5" font-family="\'Inter\', -apple-system, sans-serif" font-weight="bold" font-size="12" text-anchor="middle" fill="currentColor" stroke="none">UI</text></svg> でUIを常時表示（MVに集中したい時はOFF）',
